...
public class BankAccountServiceListAccountsBenchmark implements BankAccountServiceBenchmarkIface {
    ...
    public void testListAccounts() {
        BankAccountListDTO dto = null;
        try {
            dto = service.listAccounts(null == lastId ? null : lastId.get(), 10);
        } catch (AccountException e) {
            //
        } catch (AccountError e) {
//            throw new RuntimeException(e);
    ...
    public void tearDown() {
        ...
        System.out.println("BankAccountServiceListAccountsBenchmark tearDown completed");
    }
